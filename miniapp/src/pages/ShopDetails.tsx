                      ...
                      onClick={(e) => {
                        if (isTelegram()) {
                          ...
                          try {
                            ...
                            WebApp?.openLink(`tel:${seller.contact_phone}`);
                          } catch {
                            window.location.href = `tel:${seller.contact_phone}`;
                          }
                        }
                      }}
                    >
      ...
      <div className="shop-details__info-strip">
        ...
        {seller.contact_phone && (
          <div className="shop-details__info-line">
            ...
            <a href={`tel:${seller.contact_phone}`} className="shop-details__phone-link">{seller.contact_phone}</a>
          </div>
        )}
      </div>
